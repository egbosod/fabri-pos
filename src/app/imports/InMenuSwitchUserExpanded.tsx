import svgPaths from "./svg-t2nttlmtd0";
...
function Group() {
  return (
    <div className="absolute inset-[10.42%_0_8.83%_0]" data-name="Group">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15.9999 11.4853">
        <g id="Group">
...
function CircleUserCircleUser() {
  return (
    <div className="relative shrink-0 size-[15px]" data-name="circle-user-circle-user">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15 15">
        <g id="circle-user-circle-user">
          <path d={svgPaths.p3ff9df00} fill="var(--fill-0, black)" id="Primary" />
        </g>
      </svg>
    </div>
  );
          ...
          <div className="overflow-clip relative shrink-0 size-[12px]" data-name="Icon / Down">
            <div className="absolute inset-[28.57%_2.93%_22.48%_2.94%]" data-name="Vector">
              <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 11.2957 5.87504">
                <path clipRule="evenodd" d={svgPaths.p7afb500} fill="var(--fill-0, #828282)" fillRule="evenodd" id="Vector" />
              </svg>
            </div>
          </div>
        </div>
...
function ProfileMenu() {
  return (
    <div className="bg-[#c7c7c8] relative rounded-[5px] shrink-0 w-[231px]" data-name="Profile menu">
...
export default function InMenuSwitchUserExpanded() {
  return (
    <div className="content-stretch flex items-start relative size-full" data-name="In menu - Switch user - Expanded">
      <ProfileMenu />
    </div>
  );
}