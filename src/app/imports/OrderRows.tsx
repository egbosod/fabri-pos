import svgPaths from "./svg-5et5s4h24b";
...
function IconDelete() {
  return (
    <div className="[grid-area:1_/_1] ml-0 mt-0 relative size-[24px]" data-name="Icon / Delete">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g clipPath="url(#clip0_199_6841)" id="Icon / Delete">
          <path clipRule="evenodd" d={svgPaths.p32297a00} fill="var(--fill-0, #1A1B1F)" fillRule="evenodd" id="Vector" />
        </g>
        <defs>
...
function Label() {
  return (
    <div className="absolute bg-[#fbe2de] box-border content-stretch flex gap-[10px] h-[17px] items-center justify-center left-0 px-[4px] py-[2px] rounded-[3px] top-0" data-name="Label">
      <p className="font-['Montserrat:Regular',sans-serif] font-normal leading-[1.75] relative shrink-0 text-[#090914] text-[11px] text-nowrap whitespace-pre">Utgått</p>
    </div>
  );
}

function VarelabelUtgatt() {
  return (
    <div className="absolute content-stretch flex items-start left-[76px] top-[33px] w-[44px]" data-name="Varelabel/Utgått">
      <Label />
    </div>
  );
}
...
export default function OrderRows() {
  return (
    <div className="overflow-clip relative rounded-[5px] size-full" data-name="Order Rows">
      <Background />
      <Slettinfo />
      <TableRow />
      <VarelabelUtgatt />
