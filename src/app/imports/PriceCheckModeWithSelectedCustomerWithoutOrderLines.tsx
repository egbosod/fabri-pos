import svgPaths from "./svg-v4b5vuykpy";
...
export default function PriceCheckModeWithSelectedCustomerWithoutOrderLines({ onClose }: { onClose?: () => void }) {
  return (
    <div className="bg-zinc-200 content-stretch flex flex-col isolate items-start relative size-full" data-name="Price check mode - With selected customer WITHOUT order lines">
