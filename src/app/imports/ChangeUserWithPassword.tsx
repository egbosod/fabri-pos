import svgPaths from "./svg-hmc1842wol";
      ...
      <div className="h-0 relative shrink-0 w-full">
        <div className="absolute inset-[-3px_0_0_0]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 67 3">
            <line id="Line 57" stroke="var(--stroke-0, white)" strokeWidth="3" x2="67" y1="1.5" y2="1.5" />
          </svg>
        </div>
      </div>
    </div>
      ...
      <div className="h-0 relative shrink-0 w-full">
        <div className="absolute inset-[-3px_0_0_0]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 70 3">
            <line id="Line 57" stroke="var(--stroke-0, black)" strokeWidth="3" x2="70" y1="1.5" y2="1.5" />
          </svg>
        </div>
      </div>
    </div>
...
function Frame1() {
  return (
    <div className="bg-[#fbf9fc] h-[406px] relative shrink-0 w-[370px]">
      <div className="content-stretch flex flex-col gap-[20px] items-center overflow-x-clip overflow-y-auto p-[20px] size-full" />
...
export default function ChangeUserWithPassword() {
  return (
    <div className="bg-[#fbf9fc] content-stretch flex flex-col isolate items-start overflow-clip relative rounded-[3px] shadow-[2px_2px_4px_0px_rgba(107,107,114,0.06),3px_10px_15px_0px_rgba(107,107,114,0.06)] size-full" data-name="Change user - With Password">
      <Header />
      <Body />
