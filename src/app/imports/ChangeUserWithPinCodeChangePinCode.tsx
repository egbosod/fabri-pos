import svgPaths from "./svg-fq9oodegma";
...
function Frame() {
  return (
    <div className="content-stretch flex gap-[11px] items-center relative shrink-0">
      <IconClient />
      <p className="font-['Montserrat:Bold',sans-serif] font-bold leading-[1.3] relative shrink-0 text-[#1a1b1f] text-[15px]">Change user, choose method</p>
    </div>
  );
}
...
function Numbpad() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0 w-full" data-name="Numbpad">
      <Frame1 />
      <Frame2 />
      <Frame3 />
      <Frame4 />
...
function Frame5() {
  return (
    <div className="bg-[#fbf9fc] h-[406px] relative shrink-0 w-[370px]">
      <div className="content-stretch flex flex-col gap-[20px] items-center overflow-x-clip overflow-y-auto p-[20px] relative size-full">
        <Numbpad />
      </div>
...
export default function ChangeUserWithPinCodeChangePinCode() {
  return (
    <div className="bg-[#fbf9fc] content-stretch flex flex-col isolate items-start overflow-clip relative rounded-[3px] shadow-[2px_2px_4px_0px_rgba(107,107,114,0.06),3px_10px_15px_0px_rgba(107,107,114,0.06)] size-full" data-name="Change user - With PIN code - Change PIN code">
      <Header />
      <Body />
