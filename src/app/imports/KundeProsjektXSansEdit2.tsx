import svgPaths from "./svg-xttf3wllo2";
    ...
    <div className="absolute bottom-[0.01%] left-0 right-0 top-0" data-name="Group">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="Group">
          ...
          <path clipRule="evenodd" d={svgPaths.p2ebd6600} fill="var(--fill-0, #22222C)" fillRule="evenodd" id="Vector (Stroke)_3" />
          ...
          <path clipRule="evenodd" d={svgPaths.p2c963880} fill="var(--fill-0, #22222C)" fillRule="evenodd" id="Vector (Stroke)_10" />
        </g>
      </svg>
    </div>
  );
...
function Group32() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0">
      <div className="[grid-area:1_/_1] ml-0 mt-0 overflow-clip relative size-[24px]" data-name="Icon / Client">
  ...
  return (
    <div className="bg-white relative shrink-0 w-full" data-name="Module header">
      ...
      <div className="size-full">
        <div className="box-border content-stretch flex flex-col gap-[10px] items-start px-[21px] py-[22px] relative w-full">
          <Group32 />
        </div>
      </div>
    </div>
    ...
    <div className="content-stretch flex flex-col items-center relative shrink-0 w-full z-[3]" data-name="Header">
      ...
      <div className="bg-white h-[58px] relative shadow-[0px_3px_3px_0px_rgba(107,107,114,0.06)] shrink-0 w-full" data-name="Tabs header with underline">
        <div className="flex flex-row items-end overflow-clip rounded-[inherit] size-full">
          <div className="box-border content-stretch flex gap-[30px] h-[58px] items-end pb-0 pt-[10px] px-[20px] relative w-full">
            <Frame427319100 />
            <Frame427319141 />
          </div>
        </div>
...
function InputAndLabel3() {
  return (
    <div className="basis-0 grid-cols-[max-content] grid-rows-[max-content] grow inline-grid min-h-px min-w-px place-items-start relative shrink-0" data-name="Input and label">
      <div className="[grid-area:1_/_1] bg-white box-border content-stretch flex gap-[10px] h-[48px] items-center justify-end ml-0 mt-[26px] px-[15px] py-[5px] relative rounded-[4px] w-[276.493px]" data-name="Select">
...
function ModuleContent() {
  return (
    <div className="bg-white h-[361px] relative rounded-[4.383px] shrink-0 w-full" data-name="Module content">
      ...
      <div className="size-full">
        <div className="box-border content-stretch flex flex-col gap-[10px] h-[361px] items-start p-[20px] relative w-full">
          <InputAndLabel />
          <InputAndLabel1 />
          <InputAndLabel2 />
          <Frame17 />
...
function Card() {
  return (
    <div className="bg-white relative rounded-[3px] shrink-0 w-full" data-name="Card">
      ...
      <div className="overflow-clip relative shrink-0 size-[12px]" data-name="Icon / Down">
        ...
        <div className="absolute bottom-[19.5%] left-0 right-0 top-[18.75%]" data-name="Vector">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12 8">
            <path d={svgPaths.p3a351d00} fill="var(--fill-0, #0D97FC)" id="Vector" />
          </svg>
        </div>
      </div>
    </div>
...
function Frame669() {
  return (
    <button className="box-border content-stretch cursor-pointer flex flex-col gap-[10px] items-end overflow-visible p-0 relative shrink-0 w-full">
      <Frame161 />
    </button>
  );
}
...
function Frame668() {
  return (
    <div className="content-stretch flex flex-col gap-[5px] items-start relative shrink-0 w-full">
      <div className="content-stretch flex flex-col gap-[5px] items-start relative shrink-0 w-full" data-name="Client info">
        <Card />
        <Frame669 />
      </div>
    </div>
...
function Frame673() {
  return (
    <div className="bg-neutral-50 h-[401px] relative shrink-0 w-[336px]">
      <div className="box-border content-stretch flex flex-col gap-[20px] h-[401px] items-start overflow-x-clip overflow-y-auto p-[20px] relative w-[336px]">
        <Frame668 />
      </div>
...
function Body() {
  return (
    <div className="content-stretch flex h-[405px] items-start overflow-clip relative shrink-0 w-full z-[2]" data-name="Body">
      <Frame672 />
      <Frame673 />
      <div className="absolute bg-white h-[136px] left-[40px] rounded-[3px] top-[208px] w-[936px]" data-name="Prosjekt">
        ...
        <div className="absolute h-0 left-0 right-0 top-[87px]">
          <div className="absolute bottom-0 left-0 right-0 top-[-1px]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 936 1">
              <line id="Line 2" stroke="var(--stroke-0, #E6E6E8)" x2="936" y1="0.5" y2="0.5" />
            </svg>
          </div>
        </div>
  ...
  return (
    <div className="bg-white relative w-full" data-name="Footer">
      <div className="flex flex-row justify-end overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex gap-[10px] isolate items-start justify-end px-[20px] py-[15px] relative w-full">
...
export default function KundeProsjektXSansEdit2() {
  return (
    <div className="bg-neutral-50 box-border content-stretch flex flex-col isolate items-start relative rounded-[3px] shadow-[2px_2px_4px_0px_rgba(107,107,114,0.06),3px_10px_15px_0px_rgba(107,107,114,0.06)] size-full" data-name="Kunde/prosjekt X Sans edit 2">
      <Header />
      <Body />
