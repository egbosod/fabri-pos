import svgPaths from "./svg-hjl2fkrg78";
...
function TableCell2() {
  return (
    <div className="bg-[rgba(255,255,255,0)] box-border content-stretch flex flex-col h-[62px] items-start justify-center overflow-clip px-[10px] py-[5px] relative shrink-0 w-[350px]" data-name="Table/Cell">
      <Frame427319115 />
    </div>
  );
}
...
function TableCell3() {
  return (
    <div className="bg-[rgba(255,255,255,0)] box-border content-stretch flex flex-col h-[62px] items-start justify-center overflow-clip px-[10px] py-[5px] relative shrink-0 w-[74px]" data-name="Table/Cell">
      <Content2 />
    </div>
  );
}
...
function TableCell4() {
  return (
    <div className="bg-[rgba(255,255,255,0)] box-border content-stretch flex flex-col h-[62px] items-start justify-center overflow-clip px-[10px] py-[5px] relative shrink-0 w-[98px]" data-name="Table/Cell">
      <Content3 />
    </div>
  );
}
...
export default function ParkedRow() {
  return (
    <div className="relative rounded-[5px] size-full" data-name="Parked row">
