...
import svgPaths from "./svg-a6igpgoobm";
...
export default function KundeProsjekt() {
  return (
    <div className="bg-[#fafafa] content-stretch flex flex-col isolate items-start overflow-clip relative rounded-[3px] shadow-[2px_2px_4px_0px_rgba(107,107,114,0.06),3px_10px_15px_0px_rgba(107,107,114,0.06)] size-full" data-name="Kunde/prosjekt">
      <div className="absolute bg-white h-[233px] left-[40px] rounded-[3px] top-[327px] w-[871px] z-[4]" data-name="Kundesøk">
        ...
        <div className="absolute h-0 left-0 right-0 top-[87px]">
          <div className="absolute inset-[-1px_0_0_0]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 871 1">
              <line id="Line 2" stroke="var(--stroke-0, #E6E6E8)" x2="871" y1="0.5" y2="0.5" />
            </svg>
          </div>
        </div>
        ...
        <div className="absolute h-0 left-[0.11%] right-[0.11%] top-[183px]">
          <div className="absolute inset-[-1px_0_0_0]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 869 1">
              <line id="Line 2" stroke="var(--stroke-0, #E6E6E8)" x2="869" y1="0.5" y2="0.5" />
            </svg>
          </div>
        </div>
        ...
        <div className="absolute h-0 left-0 right-[0.11%] top-[135px]">
          <div className="absolute inset-[-1px_0_0_0]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 870 1">
              <line id="Line 2" stroke="var(--stroke-0, #E6E6E8)" x2="870" y1="0.5" y2="0.5" />
            </svg>
          </div>
        </div>
