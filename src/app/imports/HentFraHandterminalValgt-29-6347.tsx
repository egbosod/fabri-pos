import svgPaths from "./svg-o0jtzqlhof";
...
function Group427319078() {
  return (
    <div className="font-['Montserrat:Regular',sans-serif] font-normal grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0 text-nowrap">
      ...
      <div className="[grid-area:1_/_1] flex flex-col justify-center ml-0 mt-[8.5px] relative text-[#1a1b1f] text-[14px] translate-y-[-50%]">
  ...
  return (
    <div className="bg-[rgba(255,255,255,0)] box-border content-stretch flex flex-col h-[62px] items-start justify-center overflow-clip px-[10px] py-[5px] relative shrink-0" data-name="Table/Cell">
      <div className="relative shrink-0 size-[24px]" data-name="Radiobutton">
        <div className="absolute inset-0">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
            <circle cx="12" cy="12" fill="var(--fill-0, #0D97FC)" id="Ellipse 53" r="12" />
          </svg>
        </div>
        <div className="absolute inset-[29.167%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 10 10">
            <circle cx="5" cy="5" fill="var(--fill-0, white)" id="Ellipse 50" r="5" />
          </svg>
        </div>
        <div className="absolute inset-0">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
...
function Group427319080() {
  return (
    <div className="font-['Montserrat:Regular',sans-serif] font-normal grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0 text-nowrap">
      ...
      <div className="[grid-area:1_/_1] flex flex-col justify-center ml-0 mt-[8.5px] relative text-[#909095] text-[14px] translate-y-[-50%]">
...
function TableCell14() {
  return (
    <div className="bg-[rgba(255,255,255,0)] box-border content-stretch flex flex-col h-[62px] items-start justify-center overflow-clip px-[10px] py-[5px] relative shrink-0 w-[545px]" data-name="Table/Cell">
      <Content12 />
    </div>
  );
}
...
function Columns1() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-[729px]" data-name="Columns">
      <TableCell11 />
      <TableCell12 />
      <TableCell13 />
      <TableCell14 />
...
function Arrow1() {
  return (
    <div className="absolute content-stretch flex gap-[10px] items-center justify-center right-[9px] top-[21px]" data-name="Arrow">
      <div className="flex items-center justify-center relative shrink-0">
        <div className="flex-none scale-y-[-100%]">
          <div className="overflow-clip relative size-[14px]" data-name="Icon / Down">
            <div className="absolute left-0 size-[48px] top-0" data-name="Icon Plate" />
            <div className="absolute bottom-[19.5%] left-0 right-0 top-[18.75%]" data-name="Vector">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14 9">
                <path d={svgPaths.p1bf14e00} fill="var(--fill-0, #6B6B72)" id="Vector" />
...
function ParkedRow() {
  return (
    <div className="relative rounded-[5px] shrink-0 w-full" data-name="Parked row">
      <div className="content-stretch flex flex-col items-start justify-center overflow-clip relative rounded-[inherit] w-full">
        ...
        <div className="absolute bg-neutral-50 h-[176px] left-px right-px top-[63px]" />
        <Columns1 />
        <Frame427319106 />
        <Arrow1 />
      </div>
    ...
    <div className="[grid-area:1_/_1] ml-0 mt-0 relative size-[24px]" data-name="Mobile Shopping Cart">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="Mobile Shopping Cart">
          <path d={svgPaths.p2190b380} id="Vector" stroke="var(--stroke-0, #42424A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
          <path d="M3.375 18H15.375" id="Vector_2" stroke="var(--stroke-0, #42424A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
          <path d={svgPaths.p20959b96} id="Vector_3" stroke="var(--stroke-0, #42424A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
          <path d={svgPaths.p1cab6780} id="Vector_4" stroke="var(--stroke-0, #42424A)" strokeWidth="1.5" />
          <path d={svgPaths.p204f6780} id="Vector_5" stroke="var(--stroke-0, #42424A)" strokeWidth="1.5" />
          <g id="Group">
            <path d={svgPaths.p9a87a40} id="Vector_6" stroke="var(--stroke-0, #42424A)" strokeWidth="1.5" />
            <path d={svgPaths.p1cca7a80} id="Vector_7" stroke="var(--stroke-0, #42424A)" strokeWidth="1.5" />
          </g>
        </g>
      </svg>
    </div>
...
export default function HentFraHandterminalValgt() {
  return (
    <div className="bg-neutral-50 relative shadow-[2px_2px_4px_0px_rgba(107,107,114,0.06),3px_10px_15px_0px_rgba(107,107,114,0.06)] size-full" data-name="Hent fra håndterminal - valgt">
