...
import svgPaths from "../imports/svg-bu0bz8fog";
...
function Slettinfo() {
  return (
    <div className="absolute content-stretch flex gap-[11px] items-start left-[652px] opacity-0 top-[19px]" data-name="slettinfo">
      <p className="font-semibold leading-[1.75] relative shrink-0 text-[14px] text-nowrap text-white whitespace-pre">Slett</p>
      <Ikoner />
    </div>
  );
}
...
export function OrderItem({
  productName = "Beslagsskrue 5,0x40 CS A-250 Corrseal",
  productCode = "23083603",
  quantity = 3.00,
  unit = "PAK",
  pricePerUnit = 179.00,
  discount = 10,
  ...
  const calculatedTotal = total ?? (quantity * pricePerUnit * (1 - discount / 100));
  const originalTotal = quantity * pricePerUnit;
  const hasDiscount = discount > 0;

  return (
    <div className="overflow-clip relative rounded-[5px] h-[62px] w-full" data-name="Row">
      <Background />
      <Slettinfo />
      <div className="absolute bg-[#f2f6f9] content-stretch flex items-start left-0 overflow-clip rounded-[5px] top-0 w-full" data-name="Table/Row">
        {/* Product name and code */}
        <div className="bg-[rgba(255,255,255,0)] box-border content-stretch flex flex-col h-[62px] items-start justify-center overflow-clip px-[10px] py-[5px] relative shrink-0" style={{ width: `${CART_COLUMNS.VARENAVN}px` }} data-name="Table/Cell">
        ...
        {/* Quantity with unit */}
        <div className="bg-[rgba(255,255,255,0)] box-border content-stretch flex flex-col h-[62px] items-end justify-center px-[10px] py-[5px] relative shrink-0" style={{ width: `${CART_COLUMNS.ANTALL}px` }} data-name="numpad">
          <div className="content-stretch flex gap-[5px] items-center relative shrink-0" data-name="Content">
            ...
            <div className="content-stretch flex gap-[10px] items-center overflow-clip relative shrink-0" data-name="Content">
              <div className="flex flex-col font-normal justify-center leading-[0] relative shrink-0 text-[#22222c] text-[14px] text-nowrap">
        ...
        {/* Price per unit */}
        <div className="bg-[rgba(255,255,255,0)] box-border content-stretch flex flex-col h-[62px] items-end justify-center px-[10px] py-[5px] relative shrink-0" style={{ width: `${CART_COLUMNS.PER_ENHET}px` }} data-name="numpad">
          <div className="content-stretch flex gap-[10px] items-center overflow-clip relative shrink-0" data-name="Content">
            <div className="content-stretch flex flex-col gap-[4px] items-center overflow-clip relative shrink-0" data-name="Textfield">
              <div className="content-stretch flex gap-[5px] items-center relative shrink-0">
                <div className="flex flex-col font-normal justify-center leading-[0] relative shrink-0 text-[#090914] text-[14px] text-nowrap">
        ...
        {/* Discount */}
        <div className="bg-[rgba(255,255,255,0)] box-border content-stretch flex flex-col h-[62px] items-end justify-center overflow-clip pl-[10px] pr-[4px] py-[5px] relative shrink-0" style={{ width: `${CART_COLUMNS.RABATT}px` }} data-name="Table/Cell">
          <div className="content-stretch flex gap-[10px] items-center overflow-clip relative shrink-0" data-name="Content">
            <div className="content-stretch flex flex-col gap-[4px] items-center overflow-clip relative shrink-0" data-name="Textfield">
        ...
        {/* Total */}
        <div className="bg-[rgba(255,255,255,0)] box-border content-stretch flex flex-col h-[62px] items-end justify-center overflow-clip px-[10px] py-[5px] relative shrink-0" style={{ width: `${CART_COLUMNS.TOTALT}px` }} data-name="Table/Cell">
          <div className="content-stretch flex gap-[10px] items-center overflow-clip relative shrink-0" data-name="Content">
            <div className="flex flex-col font-medium justify-center leading-[19px] relative shrink-0 text-[#22222c] text-[0px] text-nowrap text-right whitespace-pre">
              <p className="mb-0 text-[14px]">{calculatedTotal.toFixed(2)}</p>
              {hasDiscount && (
                <p className="[text-decoration-skip-ink:none] [text-underline-position:from-font] decoration-solid font-normal line-through text-[#6b6b72] text-[12px]">{originalTotal.toFixed(2)}</p>
              )}
            </div>
          </div>
        </div>
