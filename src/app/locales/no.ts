...
const no: Translations = {
  ...
  proCardScanAction: 'Skann PRO-kort',
  proCardModalTitle: 'PRO-kort',
  proCardNumberLabel: 'Kortnummer',
  proCardNumberPlaceholder: 'Skann eller skriv inn kortnummer',
  proCardNotFound: 'PRO-kort ikke funnet.',
  proCardBlockedError: 'Dette PRO-kortet er sperret. Salget kan ikke fullføres.',
  proCardOfflineError: 'Oppslag på PRO-kort krever tilkobling. Du er offline.',
  proCardRegistered: 'PRO-kort registrert',
  proCardStatusOpen: 'Åpen',
  proCardStatusBlocked: 'Sperret',
  removeProCard: 'Fjern PRO-kort',
  proCardCreditTitle: 'KREDITT',
  proCardCreditUsed: 'Brukt',
  proCardCreditRemaining: 'Gjenstående',
  proCardRequisitionLabel: 'Rekvisisjonsnummer',
  proCardProjectNumberLabel: 'Prosjektnummer',
  proCardProjectNameLabel: 'Prosjektnavn',
  proCardCannotFinalize: 'Salget kan ikke fullføres mens PRO-kortet er sperret.',
  proCardDeliveryNoteOnly: 'PRO-kort aktivt — salget må fullføres som følgeseddel. Kontant betaling er ikke tilgjengelig.',
  ...
  proCardReturnBlocked: 'Det kan ikke legges til returvarer mens et PRO-kort er aktivt.',
  proCardPricingContext: 'Prisen gjenspeiler det aktive PRO-kortet.',
};
