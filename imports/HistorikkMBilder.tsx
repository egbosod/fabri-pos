import svgPaths from "./svg-8p5rfk41ky";
import imgImage38 from "figma:asset/2a8189f6f2eaf0882cfe0cd637b5bb36e06db9f0.png";
import imgImage37 from "figma:asset/6af9a29abe6cee10ae795af6c5b4a3b648c1feab.png";
import imgImage36 from "figma:asset/d6c367d2f442690bbcdf80a295a0a0f92e214c12.png";
type TableCellProps = {
  text: string;
};
...
function Checkbox1() {
  return (
    <div className="bg-white relative rounded-[5px] shrink-0 size-[24px]">
...
function TableCellText({ text }: TableCellTextProps) {
  return (
    <div className="bg-[rgba(255,255,255,0)] content-stretch flex gap-[10px] items-center overflow-clip px-[10px] py-[5px] relative shrink-0 w-[201px]">
      <div className="relative shrink-0" data-name="stepper">
        <div className="flex flex-row items-center justify-center size-full">
          <div className="content-stretch flex items-center justify-center relative">
            <div className="bg-white content-stretch flex items-center justify-center px-[13.333px] py-[8px] relative rounded-bl-[5px] rounded-tl-[5px] shrink-0 size-[48px]">
            ...
            <div className="bg-white content-stretch flex flex-col gap-[8px] items-center justify-center px-[20px] py-[11px] relative shrink-0 size-[48px]">
              <div aria-hidden="true" className="absolute border-[#d5d5d7] border-b border-solid border-t inset-0 pointer-events-none" />
              <p className="font-['Montserrat:SemiBold',sans-serif] font-semibold leading-[1.75] relative shrink-0 text-[#090914] text-[14px] whitespace-nowrap">{"4"}</p>
            </div>
            <button className="bg-[#f5f5f6] content-stretch cursor-pointer flex h-[46px] items-center justify-center px-[13px] py-[6px] relative rounded-br-[5px] rounded-tr-[5px] shrink-0 w-[48px]">
      ...
      <div className="flex flex-col font-['Montserrat:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#090914] text-[14px] whitespace-nowrap">
        <p className="leading-[1.38]">{text}</p>
      </div>
    </div>
  );
}
...
function ButtonsButtonText({ text }: ButtonsButtonTextProps) {
  return (
    <div className="bg-white h-[48px] min-w-[100px] relative rounded-[5px] shrink-0">
      <div aria-hidden="true" className="absolute border border-[#d5d5d7] border-solid inset-0 pointer-events-none rounded-[5px]" />
      <div className="flex flex-row items-center justify-center min-w-[inherit] size-full">
        <div className="content-stretch flex h-full items-center justify-center min-w-[inherit] px-[20px] py-[6px] relative">
          <p className="font-['Montserrat:SemiBold',sans-serif] font-semibold leading-[1.75] relative shrink-0 text-[#090914] text-[13px] whitespace-nowrap">{text}</p>
        </div>
      </div>
    </div>
  );
...
export default function HistorikkMBilder() {
  return (
    <div className="bg-[#fafafa] overflow-clip relative rounded-[3px] shadow-[2px_2px_4px_0px_rgba(107,107,114,0.06),3px_10px_15px_0px_rgba(107,107,114,0.06)] size-full" data-name="Historikk m. bilder">
      ...
      <div className="absolute bottom-0 flex items-center justify-center left-0 w-[1024px]">
              ...
              <div className="flex items-center justify-center relative shrink-0 z-[1]">
                <div className="flex-none rotate-180">
                  <div className="content-stretch flex gap-[20px] items-center relative" data-name="Buttons">
                    <div className="bg-[#0d97fc] h-[48px] min-w-[100px] relative rounded-[5px] shrink-0" data-name="Button">
                      <div className="flex flex-row items-center justify-center min-w-[inherit] size-full">
                        <div className="content-stretch flex h-full items-center justify-center min-w-[inherit] px-[20px] py-[6px] relative">
                          <p className="font-['Montserrat:SemiBold',sans-serif] font-semibold leading-[1.75] relative shrink-0 text-[15px] text-white whitespace-nowrap">Add as return</p>
                        </div>
                      </div>
                    </div>
                    <ButtonsButtonText text="Add as regular sale" />
                    <ButtonsButtonText text="Print exchange slip" />
      ...
      <div className="absolute h-[864px] left-0 top-[113px] w-[1024px]" data-name="Body">
        <div className="absolute bg-white border border-[#e6e6e8] border-solid h-[462px] left-[17px] rounded-[4.383px] top-[16px] w-[991px]" data-name="Module content">
          <div className="absolute contents left-[14px] top-[120px]" data-name="History result">
            ...
            <div className="absolute left-[15px] rounded-[5px] top-[148px] w-[959px]" data-name="Expanded and selected row">
              <div className="content-stretch flex flex-col items-start justify-center overflow-clip relative rounded-[inherit] w-full">
                <div className="bg-[#f0f9ff] h-[62px] relative rounded-tl-[5px] rounded-tr-[5px] shrink-0 w-full" data-name="header">
                      ...
                      <div className="content-stretch flex items-center justify-center relative" data-name="Arrow">
                        <div className="overflow-clip relative shrink-0 size-[14px]" data-name="Icon / Down">
                          ...
                          <div className="absolute inset-[18.75%_0_19.5%_0]" data-name="Vector">
                            <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14 8.645">
                  ...
                  <div className="absolute content-stretch flex items-center left-0 top-0 w-[912px]" data-name="Columns">
                    <div className="bg-[rgba(255,255,255,0)] content-stretch flex flex-col h-[62px] items-start justify-center overflow-clip px-[10px] py-[5px] relative shrink-0 w-[44px]" data-name="Table/Cell">
                      <Checkbox className="bg-[#0d97fc] block cursor-pointer relative rounded-[5px] shadow-[0px_3px_3px_0px_rgba(107,107,114,0.06)] shrink-0 size-[24px]" status="Intermediate" />
                    </div>
                    ...
                    <div className="bg-[rgba(255,255,255,0)] content-stretch flex flex-col h-[62px] items-end justify-center overflow-clip px-[10px] py-[5px] relative shrink-0 w-[87px]" data-name="Table/Cell">
                      <div className="content-stretch flex items-center justify-end overflow-clip relative shrink-0" data-name="Content">
                        <div className="flex flex-col font-['Montserrat:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#22222c] text-[14px] text-right whitespace-nowrap">
                          <p className="leading-[normal]">58,200.75</p>
                        </div>
                      </div>
                    </div>
                  </div>
                </div>
                <div className="bg-white content-stretch flex flex-col items-start justify-center relative shrink-0 w-full" data-name="body">
                  <div className="content-stretch flex flex-col items-start justify-center relative shrink-0 w-full">
                    <div className="content-stretch flex items-start overflow-clip relative shrink-0 w-full" data-name="Table/Row">
                      ...
                      <div className="bg-[rgba(255,255,255,0)] content-stretch flex flex-col h-[28px] items-start justify-end overflow-clip pl-[61px] pr-[10px] relative shrink-0 w-[207px]" data-name="Table/Cell">
                        <ContentText text="Quantity" />
                      </div>
                      <div className="bg-[rgba(255,255,255,0)] content-stretch flex flex-col h-[28px] items-end justify-end overflow-clip px-[10px] relative shrink-0 w-[82px]" data-name="Table/Cell">
                        <ContentText text="Per unit" />
                      </div>
                      <div className="bg-[rgba(255,255,255,0)] content-stretch flex flex-col h-[28px] items-start justify-end overflow-clip px-[10px] relative shrink-0 w-[70px]" data-name="Table/Cell">
                        <ContentText text="Discount" />
                      </div>
                      <div className="bg-[rgba(255,255,255,0)] content-stretch flex flex-col h-[28px] items-end justify-end overflow-clip pl-[30px] pr-[32px] relative shrink-0 w-[102px]" data-name="Table/Cell">
                        <ContentText text="Total" />
                      </div>
                    </div>
                    <div className="bg-[#f0f9ff] h-[67px] relative shrink-0 w-full" data-name="Table/Row">
                      <div className="content-stretch flex items-center overflow-clip relative rounded-[inherit] size-full">
                        <div className="bg-[rgba(255,255,255,0)] content-stretch flex flex-col h-[49px] items-start justify-center overflow-clip px-[10px] py-[5px] relative shrink-0 w-[44px]" data-name="Table/Cell">
                          <Checkbox className="bg-[#0d97fc] block cursor-pointer relative rounded-[5px] shadow-[0px_3px_3px_0px_rgba(107,107,114,0.06)] shrink-0 size-[24px]" status="Active" />
                        </div>
                        ...
                        <TableCell text="Tube cream 5.0x40 CS A-250 Corrseal 23083603" />
                        <TableCellText text="PCS" />
                        <div className="bg-[rgba(255,255,255,0)] content-stretch flex flex-col items-end justify-center px-[10px] py-[5px] relative shrink-0 w-[82px]" data-name="numpad">
                          <div className="content-stretch flex h-[40px] items-center overflow-clip relative shrink-0" data-name="Content">
                            <Textfield />
                          </div>
                        </div>
                        <div className="bg-[rgba(255,255,255,0)] content-stretch flex flex-col items-end justify-center overflow-clip pl-[10px] pr-[4px] py-[5px] relative shrink-0 w-[64px]" data-name="Table/Cell">
                          <div className="content-stretch flex h-[40px] items-center overflow-clip relative shrink-0" data-name="Content">
                            <Textfield1 />
                          </div>
                        </div>
                        <div className="bg-[rgba(255,255,255,0)] content-stretch flex flex-col items-end justify-center overflow-clip pl-[30px] pr-[32px] py-[5px] relative shrink-0 w-[107px]" data-name="Table/Cell">
                          <Content text="483.30" text1="537.00" />
                        </div>
                      </div>
                    ...
                    <div className="h-[67px] relative shrink-0 w-full" data-name="Table/Row">
                      <div className="content-stretch flex items-center overflow-clip relative rounded-[inherit] size-full">
                        ...
                        <div className="bg-[rgba(255,255,255,0)] content-stretch flex flex-col h-[49px] items-center justify-center overflow-clip px-[10px] py-[5px] relative shrink-0 w-[56px]" data-name="Table/Cell">
                          <div className="relative rounded-[5px] shrink-0 size-[36px]" data-name="image 37">
                            <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[5px] size-full" src={imgImage37} />
                          </div>
                        </div>
                        <TableCell text="Planki plank 5.0x40 CS A-250 Corrseal 23083603" />
                        <TableCellText text="PCS" />
                        <div className="bg-[rgba(255,255,255,0)] content-stretch flex flex-col items-end justify-center px-[10px] py-[5px] relative shrink-0 w-[82px]" data-name="numpad">
                          <div className="content-stretch flex h-[40px] items-center overflow-clip relative shrink-0" data-name="Content">
                            <Textfield />
                    ...
                    <div className="h-[67px] relative shrink-0 w-full" data-name="Table/Row">
                      <div className="content-stretch flex items-center overflow-clip relative rounded-[inherit] size-full">
                        ...
                        <div className="bg-[rgba(255,255,255,0)] content-stretch flex flex-col h-[49px] items-center justify-center overflow-clip px-[10px] py-[5px] relative shrink-0 w-[56px]" data-name="Table/Cell">
                          <div className="relative rounded-[5px] shrink-0 size-[36px]" data-name="image 36">
                            <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[5px] size-full" src={imgImage36} />
                          </div>
                        </div>
                        <div className="bg-[rgba(255,255,255,0)] content-stretch flex flex-col items-start justify-center overflow-clip px-[10px] py-[5px] relative shrink-0 w-[405px]" data-name="Table/Cell">
                          <div className="content-stretch flex items-center overflow-clip relative shrink-0">
                            <div className="flex flex-col font-['Montserrat:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#22222c] text-[14px] whitespace-nowrap">
                              <p className="leading-[19px]">{"Door plank 5.0x40 CS A-250 Corrseal 23083603"}</p>
                            </div>
                          </div>
                        </div>
                        <TableCellText text="PCS" />
